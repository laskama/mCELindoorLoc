...
class ThreeDregModel(BaseModel):

    def __init__(self, model_params, data_provider: ThreeDdataProvider, base_dir, model=None, model_name='model'):
        super(ThreeDregModel, self).__init__(model_params, data_provider, base_dir, model, model_name)
